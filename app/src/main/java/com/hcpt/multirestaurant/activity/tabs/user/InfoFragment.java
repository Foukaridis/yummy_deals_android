...
public class InfoFragment extends BaseFragment implements OnClickListener {
    ...
    private void setData() {
        ...
        if (!GlobalValue.myAccount.getPassword().isEmpty()) {
    ...
    public void onClick(View v) {
        ...
        if (v == btnUpdateInfor) {
            ...
            activity.gotoFragment(MainUserActivity.UPDATEINFOR_PAGE);
        }
        if (v == btnUpdatePass) {
            MainUserActivity activity = (MainUserActivity) getCurrentActivity();
            activity.gotoFragment(MainUserActivity.UPDATEPASS_PAGE);
        }
        if (v == btnBack) {
            MainUserActivity activity = (MainUserActivity) getCurrentActivity();
