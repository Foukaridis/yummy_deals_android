...
import com.hcpt.multirestaurant.adapter.ListOfferAdapter;
import com.hcpt.multirestaurant.config.GlobalValue;
import com.hcpt.multirestaurant.fragment.BannerFragment;
...
import com.hcpt.multirestaurant.object.Banner;
import com.hcpt.multirestaurant.object.Offer;
import com.hcpt.multirestaurant.object.OpenHour;
...
public class ShopDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private void getListOffers(int shopId) {
                ...
                new ModelManagerListener() {
                    ...
                    public void onSuccess(Object object) {
                        ...
                        lblBestDeal.setText("Best Deals: "
                                + arrOffer.size());
                        offerAdapter = new ListOfferAdapter(self, arrOffer);
                        lsvOffer.setAdapter(offerAdapter);
                    }
