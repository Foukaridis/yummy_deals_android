package com.hcpt.multirestaurant.config;

public final class WebServiceConfig {
	public static final String HOST = "http://www.friilance.co.za/";
	public static final String WEB_PATH = "yummydeals/";
	...
	public static final String ACTION_GET_USER_INFOR = "getUserInfo";
